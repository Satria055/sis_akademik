...
class Krs extends CI_Controller{
    ...
    public function krs_aksi(){
        ...
        $dataKrs = array(
            ...
            'nim'       => $nim,
            'id_akademik'       => $thn_akademik,
            'tahun_akademik'    => $this->tahun_akademik_model->get_by_id($thn_akademik)->tahun_akademik,
            'semester'          => $this->tahun_akademik_model->get_by_id($thn_akademik)->semester == 'Ganjil'?'Ganjil':'Genap',
            'nama_lengkap'    => $this->mahasiswa_model->get_by_id($nim)->nama_lengkap,
            'nama_jurusan'    => $this->mahasiswa_model->get_by_id($nim)->nama_jurusan,
        );
            $this->load->view('templates_administrator/header');
            $this->load->view('templates_administrator/sidebar');
    ...
    public function baca_krs($nim, $thn_akademik){
        ...
        $this->db->where('k.id_akademik', $thn_akademik);
    ...
    public function tambah_krs($nim, $thn_akademik){
        $data = array(
            ...
            'id_akademik' => $thn_akademik,
            'thn_akademik_semester' => $this->tahun_akademik_model->get_by_id($thn_akademik)->tahun_akademik,
            'semester' => $this->tahun_akademik_model->get_by_id($thn_akademik)->semester == 'Ganjil'?'Ganjil':'Genap',
            'nim' => $nim,
    ...
    public function tambah_krs_aksi(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            $this->input->post('id_akademik', TRUE) );
        }else{
            $nim = $this->input->post('nim', TRUE);
    ...
    public function _rules(){
        $this->form_validation->set_rules('id_akademik', 'id_akademik', 'required');
        $this->form_validation->set_rules('nim', 'nim', 'required');
    ...
    public function update($id){
        ...
        if($row){
            $data = array(
                ...
                'id_akademik' => set_value('id_akademik', $row->id_akademik),
                'nim' => set_value('nim', $row->nim),
                'kode_matakuliah' => set_value('kode_matakuliah', $row->kode_matakuliah),
                'thn_akademik_semester' => $this->tahun_akademik_model->get_by_id($th)->tahun_akademik,
