...
class Matakuliah extends CI_Controller{
    ...
    public function _rules(){
        $this->form_validation->set_rules('kode_matakuliah', 'kode_matakuliah', 'required',[
            'required' => 'Silahkan input kode mata kuliah'
        ]);
        $this->form_validation->set_rules('nama_matakuliah', 'nama_matakuliah', 'required',[
            'required' => 'Silahkan input nama mata kuliah'
        ]);
        $this->form_validation->set_rules('sks', 'sks', 'required',[
            'required' => 'Silahkan input jumlah SKS'
        ]);
    ...
    public function update($id){
        ...
        $data['matakuliah'] = $this->db->query("select * from matakuliah mk, 
        jurusan jrs where mk.nama_jurusan=jrs.nama_jurusan and mk.kode_matakuliah='$id'")->result();
        $data['jurusan'] = $this->matakuliah_model->tampil_data('jurusan')->result();
            $this->load->view('templates_administrator/header');
            $this->load->view('templates_administrator/sidebar');
